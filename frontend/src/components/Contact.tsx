  ...
  const contactInfo = [
    {
      icon: '📧',
      title: 'Email',
      value: 'meena@example.com',
      link: 'mailto:meena@example.com'
    },
    {
      icon: '📱',
      title: 'Phone',
    ...
    },
    {
      icon: '💼',
      title: 'LinkedIn',
      value: 'linkedin.com/in/meenakannan',
      link: 'https://linkedin.com/in/meenakannan'
    }
  ];
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <p className="text-secondary-600 group-hover:text-primary-600 transition-colors">
                      {info.value}
                    </p>
                  </motion.a>
                ))}
